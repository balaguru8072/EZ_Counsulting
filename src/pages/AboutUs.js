    ...
    return (
        <>
            ...
            <main className="page-wrapper">
                ...
                {/* Start Slider Area  */}
                <div className="slider-area slider-style-1 height-850 bg_image" data-black-overlay="7" style={{ backgroundImage: `url(https://doob.rainbowit.net/images/bg/bg-image-12.jpg)` }}>
                ...
                <div className="service-area rn-section-gapTop">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <p className="mb--10">we recognise data’s role in business operations. Our team of experts is
                                    dedicated to using data to empower organisations like yours to make
                                    informed decisions and achieve meaningful outcomes.
                                </p>
                            </div>
                        </div>
                    </div>
