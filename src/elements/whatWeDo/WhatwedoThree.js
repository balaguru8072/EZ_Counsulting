                                    ...
                                    <ul className="feature-list">
                                        <li>
                                            <div className="title-wrapper">
                                                ...
                                                <p className="text" >Our IT experts are ready to take your business to the
                                                    next level, are you?</p>
                                                <Button variant="warning" className="case-study-button" style={{ fontSize: "medium", color: "white", fontWeight: "900" }}>Hear from out team</Button>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
